...
* `s.startswith()`: Returns True if a string starts with the specified prefix(string). If not, it returns False.
* `s.find()`: The find method finds the first occurrence of the specified value.
