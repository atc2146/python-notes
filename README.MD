...
* The `copy()` method copies the list. Note there are other ways of copying a list including slicing or forcing the list type.
...
Order matters in permutation while it does in a combinations.
