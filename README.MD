...
### Heaps
A [heap](https://en.wikipedia.org/wiki/Heap_(data_structure)) is a specialized tree-based data structure which essentially an almost complete tree that satisfies the heap property:
...
# popped is 1
 ...
 Note you can implement a [max heap](https://stackoverflow.com/questions/2501457/what-do-i-use-for-a-max-heap-implementation-in-python) in python using the negative of a list.
